...
export const studio = {
  name: "Banawat Architect's",
  logoMain: "Banawat",
  logoSub: "Architects",
  tagline: "Where Architecture Meets Everyday Life.",
  heroEyebrow: "Architecture Studio · Faridabad",
  heroLines: ["Architecture,", "designed", "around you."],
  heroFoot: "Est. Faridabad · Delhi NCR",
  introLead:
    "Banawat Architect's is a Faridabad architecture and design practice shaping homes and commercial spaces across Delhi NCR. We work from first principles — light, proportion, material and site — to create buildings and interiors that are precise, timeless and deeply liveable.",
  address: "4th Floor, Vipul Plaza, C-414, Sector 81, Faridabad, Haryana 121007",
  phoneDisplay: "+91 92666 64950",
  phoneHref: "+919266664950",
  email: "studio@banawatarchitects.in",
  instagram: "banawatarchitects",
  instagramUrl: "https://instagram.com/banawatarchitects",
}
